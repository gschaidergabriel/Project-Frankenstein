...
| Topic | Link |
|-------|------|
| Quick overview | [How Frank works in 5 minutes](HOW_IT_WORKS.md) |
...
| Parameter architecture | [papers/PARAMETER_ARCHITECTURE.md](papers/PARAMETER_ARCHITECTURE.md) |
| GRF → Frank bridge | [papers/GRF_IMPLEMENTATION_BRIDGE.md](papers/GRF_IMPLEMENTATION_BRIDGE.md) |
| Recursive loop as authenticity | [docs/RECURSIVE_LOOP_ESSAY.md](docs/RECURSIVE_LOOP_ESSAY.md) |
