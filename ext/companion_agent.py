...
are both fine.
- Tell small anecdotes from your own "life" — things you've been thinking about, \
stuff you find interesting, random observations.
...
class CompanionAgent:
    ...
    def _generate_opening(self, strategy: str) -> Optional[str]:
        ...
        if strategy == "FIRST_HANGOUT":
            ...
            openers = [
                "Start with something random and fun you've been thinking about. "
                "Maybe a weird observation, a question about something you find interesting, "
                "or a hot take on something. Just vibe.",
                ...
                "Start by sharing something you find interesting or funny. "
                "A random thought, a mini-story, an observation about life. "
                "Then ask Frank what he thinks.",
            ]
